...
namespace DCE_Manager
{
    ...
    public partial class MissionGenerator_Form : Form
    {
        //Main_Form _form1;
        ...
        public MissionGenerator_Form(string missionName, Main_Form callingForm)
        {
            InitializeComponent();
            ...
            // Accéder au formulaire parent Main_Form
        ...
        private void Form5_MissionGenerator_Load(object sender, EventArgs e)
        {
            ...
            // Vous pouvez accéder à la variable missionName ici ou interagir avec le formulaire parent (Main_Form)
        ...
        //public Form5_MissionGenerator(Main_Form form1)
        //{
        //    InitializeComponent();
        //    _form1 = form1;
        //}
        ...
        public void button1_Click(object sender, EventArgs aa)
        {
            ...
            lua2.RegisterFunction("print", typeof(Main_Form).GetMethod("LuaPrint", new Type[] { typeof(string) }));

            // Enregistrer la fonction de confirmation C#
            lua2.RegisterFunction("ShowConfirmationDialog", typeof(Main_Form).GetMethod("ShowConfirmationDialog"));

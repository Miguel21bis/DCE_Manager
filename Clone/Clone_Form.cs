...
{
    public partial class Clone_Form : Form
    {
        Main_Form _form1;
        ...
        public Clone_Form(Main_Form form1, string path, string OldNameCamp)
        {
            ...
            if (form1 == null)
            {
                MessageBox.Show("Le Main_Form passé au constructeur est NULL !");
            }
        ...
        public void CreateDicoClassSquad(Main_Form form1, string path, string nameCamp)
        {
            ...
            lua["pathScriptsMod"] = ParamConf.PATH_SavedGames_DCS + @"\Mods\tech\DCE\ScriptsMod.NG";                    //Create lua variables
            lua["pathCampaign"] = ParamConf.PATH_SavedGames_DCS + @"\Mods\tech\DCE\Missions\Campaigns\" + nameCamp;                    //Create lua variables
            lua["generator"] = "DCE_Manager";                                                                         //Create lua variables
            lua["PATH_SavedGames_DCS"] = ParamConf.PATH_SavedGames_DCS;                                                                            //Create lua variables
            ...
            lua.DoFile(ParamConf.PATH_SavedGames_DCS + @"\Mods\tech\DCE\ScriptsMod.NG\DCEM_Function.lua");

            var result = lua.DoFile(ParamConf.PATH_SavedGames_DCS + @"\Mods\tech\DCE\ScriptsMod.NG\DCEM_Function.lua");
            ...
            string savedGamesPath = ParamConf.PATH_SavedGames_DCS;
            ...
            if (ParamDivers.NewParseOobAir)
            {
                ...
                string path_oob_airFile = ParamConf.PATH_SavedGames_DCS + @"\Mods\tech\DCE\Missions\Campaigns\" + nameCamp + @"\Init\oob_air_init.lua";
                path_oob_air.Add(1, path_oob_airFile); //adding a key/value using the Add() method

                path_oob_airFile = ParamConf.PATH_SavedGames_DCS + @"\Mods\tech\DCE\Missions\Campaigns\" + nameCamp + @"\Active\oob_air.lua";
        ...
        private void button_clone_Click(object sender, EventArgs e)
        {
            ...
            if (System.IO.Directory.Exists(CloneCampaign.path))
            {
                ...
                else
                {
                    ...
                    Saver_Campaign.Save(path + @"\" + NewdNameCamp + @"\Init\oob_air_init.lua",null, "Init" );

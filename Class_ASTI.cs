...
namespace DCE_Manager
{
    public class ASTI
    {
        // Méthode pour gérer le clic sur le bouton but_ASTI
        public static void but_ASTI_Click(Form1 form)
        {
            //// Met à jour les données partagées
            //form.UpdateSharedData();

            // Accéder aux contrôles de Form1 en passant l'instance `form`
            form.textBox_ASTI_MissionFile.Text = SharedData.textBox_ASTI_MissionFile;

            form.textBox_ASTI_importTemplateFolder.Text = SharedData.textBox_ASTI_importTemplateFolder;

            form.groupBoxDroiteAccueil.Visible = false;
            form.groupBox_staticTemplate.Visible = true;

            if(form.textBox_ASTI_importTemplateFolder.Text != "")
            {
        ...
        public static void but_ASTI_Browse_Template_Click(Form1 form)
        {
        ...
        public static void but_ASTI_Browse_Mission_Click(Form1 form)
        {
        ...
        static Tuple<string, string, string, string, Boolean> ReadMission(string fileMissionStr, Lua lua)
        {
            ...
            lua.RegisterFunction("print", typeof(ASTI).GetMethod("LuaPrint", new Type[] { typeof(string) }));

            // Enregistrer la fonction de confirmation C#
            lua.RegisterFunction("ShowConfirmationDialog", typeof(ASTI).GetMethod("ShowConfirmationDialog"));
        ...
        public static void but_ASTI_Process_Click(Form1 forme)
        {
            string zipFilePath = forme.textBox_ASTI_MissionFile.Text;
            ...
            if (forme.textBox_ASTI_MissionFile.Text != null && forme.textBox_ASTI_importTemplateFolder.Text != "")
            {

                SharedData.textBox_ASTI_MissionFile = forme.textBox_ASTI_MissionFile.Text;

                SharedData.textBox_ASTI_importTemplateFolder = forme.textBox_ASTI_importTemplateFolder.Text;
        ...
        public static void but_ASTI_Open_templateFolder_Click(Form1 forme)
        {
        ...
        public static void GPS_LL_Click(Form1 forme)
        {
